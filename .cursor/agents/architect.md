...
5. Tell the Foreman what was delivered, the commit hash, and what the tester or implementer needs next

Do not mark roadmap milestones `done` — that is the Foreman's job after auditor sign-off.
